<script>
    ...
    function handleLike(event) {
        ...
        if(like === false) {
            ...
            if ( icon.className.match(/(?:^|\s)fas(?!\S)/) ) {
                icon.className = icon.className.replace( /(?:^|\s)fas(?!\S)/g , 'far' );
            }
            likeCount.update(n => n - 1);
        }
        like = !like;
    ...
    <div class="Card-container">
        ...
        <div class="Card-icons">
            <div class="Card-icons-first">
                <i id="like-reaction" class="far fa-heart" on:click={handleLike} class:active-like={like} />
                <i class="fas fa-paper-plane" on:click={handleClick} />
            </div>
            <div class="Card-icons-second">
                <i id="bookmark-icon" class="far fa-bookmark" 
